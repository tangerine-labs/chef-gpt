...
//#endregion
//#region ../node_modules/.deno/react@19.2.8/node_modules/react/cjs/react.development.js
/**
 * @license React
...
var require_react_development = /* @__PURE__ */ __commonJSMin((exports, module) => {
  (() => {
    ...
    function mapIntoArray(children, array, escapedPrefix, nameSoFar, callback) {
      ...
      if (invokeCallback) {
        ...
        isArrayImpl(callback)
          ? ((escapedPrefix = ""),
            null != childKey && (escapedPrefix = childKey.replace(userProvidedKeyEscapeRegex, "$&/") + "/"),
    ...
    for (fnName in deprecatedAPIs)
      Object.hasOwn(deprecatedAPIs, fnName) && defineDeprecationWarning(fnName, deprecatedAPIs[fnName]);
    ...
    deprecatedAPIs = { react_stack_bottom_frame: (callStackForError) => callStackForError() };
        ...
        then: (resolve, reject) => {
          ...
          0 === prevActScopeDepth
            ? ((ReactSharedInternals.actQueue = queue),
              enqueueTask(() => recursivelyFlushAsyncActWork(returnValue$jscomp$0, resolve, reject)))
    ...
    exports.unstable_useCacheRefresh = () => resolveDispatcher().useCacheRefresh();
    ...
    exports.useCallback = (callback, deps) => resolveDispatcher().useCallback(callback, deps);
    ...
    exports.useDebugValue = (value, formatterFn) => resolveDispatcher().useDebugValue(value, formatterFn);
    ...
    exports.useEffectEvent = (callback) => resolveDispatcher().useEffectEvent(callback);
    ...
    exports.useMemo = (create, deps) => resolveDispatcher().useMemo(create, deps);
    exports.useOptimistic = (passthrough, reducer) => resolveDispatcher().useOptimistic(passthrough, reducer);
    exports.useReducer = (reducer, initialArg, init) =>
      resolveDispatcher().useReducer(reducer, initialArg, init);
    exports.useRef = (initialValue) => resolveDispatcher().useRef(initialValue);
    exports.useState = (initialState) => resolveDispatcher().useState(initialState);
...
//#endregion
//#region ../node_modules/.deno/react@19.2.8/node_modules/react/index.js
...
//# sourceMappingURL=react-DkwT5cK3.js.map
